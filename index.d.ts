...
export declare class ActionsObservable<T extends Action> extends Observable<T> {
  ...
  static of<T extends Action>(
    ...array: Array<T | Scheduler>
  ): ActionsObservable<T>;

  static from<T extends Action>(
    ish: ObservableInput<T>,
    scheduler?: Scheduler
  ): ActionsObservable<T>;
  static from<T extends Action, R extends Action>(
    ish: ArrayLike<T>,
    scheduler?: Scheduler
  ): ActionsObservable<R>;
...
export interface EpicMiddleware<T extends Action, S, D = any, O extends T = T>
  extends Middleware {
...
export declare function createEpicMiddleware<
  ...
  D = any,
  O extends T = T
>(rootEpic: Epic<T, S, D, O>, options?: Options<D>): EpicMiddleware<T, S, D, O>;

export declare function combineEpics<
  T extends Action,
  S,
  D = any,
  O extends T = T
>(...epics: Epic<T, S, D, O>[]): Epic<T, S, D, O>;
