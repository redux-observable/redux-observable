...
const config: Config = {
  ...
  tagline: 'RxJS-based middleware for Redux',
  ...
  organizationName: 'redux-observable', // Usually your GitHub org/user name.
  projectName: 'redux-observable', // Usually your repo name.
